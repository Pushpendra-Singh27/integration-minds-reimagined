    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 hero-text-glow">
              Block<span className="bg-gradient-secondary bg-clip-text text-transparent">chain</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Deep understanding of the Blockchain ecosystem to develop and implement secure, scalable distributed ledger solutions
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Expert advisory, architecture, and delivery of secure blockchain and distributed ledger technology solutions
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <Card className="h-full hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-4 text-primary">Advisory & Architecture</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Strategic advisory, architecture design, and delivery of secure blockchain and DLT solutions 
            ...
            >
              <Card className="h-full hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-4 text-secondary">Platform & Patterns</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Pragmatic use of the right blockchain platforms and design patterns optimized 
                    for your specific industry and use-cases.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-background/80 max-w-3xl mx-auto">
              Comprehensive blockchain services from strategy to implementation and beyond
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-subtle">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Leverage our Subject Matter Experts across leading blockchain platforms and technologies
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/10 via-secondary/5 to-background">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Build on <span className="bg-gradient-secondary bg-clip-text text-transparent">Blockchain?</span>
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Let our blockchain experts help you implement secure, scalable distributed ledger solutions
            </p>
